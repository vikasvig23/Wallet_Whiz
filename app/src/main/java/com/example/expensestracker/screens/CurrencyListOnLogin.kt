...
@Composable
fun CurrencyListOnLogin(currency: List<Currencies>,onCurrencySelected: (Currencies) -> Unit) {
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun AddCurrencyOnLogin(navController: NavController){
